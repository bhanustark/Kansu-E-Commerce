...
?>
    ...
    <div class="gallery row">
            ...
            <?php if(isset($product->price_id)) { if(in_array($product->price_id,$price_ids)) { ?>
            ...
            <?php
              if($product->offer_price != 0) {
               ...
               $percent = ($product->price - $product->offer_price)/$product->price ;
              }
            ?>
            ...
            <div class="gallery-curve-wrapper">
              ...
              <div class="gallery-header">
                ...
                <span class="price" data-product-price="">
                  <?php if(isset($product->price)){ ?><?php if($product->offer_price == 0)
                  { ?><span style="color:green;" class="fa fa-inr" > <?= $product->price ?></span>
                  <?php } else { ?> <span style="background:green;color:#fff;"><?=substr($percent,0,4)?>% Off</span> 
                  <span style="color:green;" class="fa fa-inr" > <?=$product->offer_price?></span> 
                  <span style="color:red;"><strike class="fa fa-inr" > <?=$product->price?></strike></span> <?php } ?> <?php  } ?>
                </span>
        </div>
              </div>
              <div class="gallery-body">
                <div class="title-wrapper">
                  ...
                  <span class="price"><?php if(isset($product->price)){ ?><?php if($product->offer_price == 0){ ?>
                  <span style="color:green;" class="fa fa-inr" > <?= $product->price ?></span><?php } else { ?> 
                  <span style="background:green;color:#fff;"><?=substr($percent,0,4)?>% Off</span> 
                  <span style="color:green;" class="fa fa-inr" > <?=$product->offer_price?></span> 
                  <span style="color:red;"><strike class="fa fa-inr" > <?=$product->price?></strike></span> <?php } ?> <?php  } ?></span>
